<!-- GENERATED by build-claude-md.sh — do NOT edit directly. -->
<!-- Edit CLAUDE.md.blueprint (structure) or the section generators (content), then re-run build-claude-md.sh. -->


<!-- SECTION: repo-descriptions -->
<!-- AUTO-GENERATED by scripts/generate-repo-descriptions.sh — do not edit by hand. -->
<!-- Last generated: 2026-08-08T14:36:52-05:00 -->
...
- **b2-backup** — `/srv/dev/repos/b2-backup` (`Surxe/b2-backup`) — (not found or dev lacks access)
...
- **dev-user** — `/srv/dev/repos/dev-user` — local-only (no GitHub remote)
