...
- **ai-ml-mock-project** — `/srv/dev/repos/ai-ml-mock-project` (`Surxe/ai-ml-mock-project`) — (no description set)
...
- **interview-exercise** — `/srv/dev/repos/interview-exercise` — local-only (no GitHub remote)
